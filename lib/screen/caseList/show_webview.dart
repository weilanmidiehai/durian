  ...
  void initState() {
    ...
    controller
      ...
      ..setNavigationDelegate(
        NavigationDelegate(
          onProgress: (int progress) {
            debugPrint('WebView 正在加载 (progress : $progress%)');
          },
      ...
      ..loadRequest(Uri.parse(
        'https://apps.powerapps.com/play/e/default-f65f0d81-a2a9-4903-a388-63a7d734d7cc/a/feaa9628-224d-40f3-a5fa-adbfe6ee1590?tenantId=f65f0d81-a2a9-4903-a388-63a7d734d7cc',
      ));
